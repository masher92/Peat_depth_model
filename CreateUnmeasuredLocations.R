...
RasterToDF_cropped <- function (aoi_fp, raster_fp) {
  ...
  raster <- raster ("Input/DTM/Dales_Nidderdale_Moorland_line_DTM_5m.tif")
...
elevation_clip_df <- RasterToDF_cropped("Humberstone_AOI", "Input/DTM/Dales_Nidderdale_Moorland_line_DTM_5m.tif")
slope_clip_df <- RasterToDF_cropped("Humberstone_AOI", "Input/DTM/Dales_Nidderdale_Moorland_line_slope_5m.tif")
...
# Save
write.csv (aoi_df, file = "Generated/UnmeasuredLocations/humberstone_aoi_df.csv", row.names = FALSE)
